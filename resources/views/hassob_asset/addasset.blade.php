                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('assets') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="picture_url" type="text" class="form-control @error('picture_url') is-invalid @enderror" name="picture_url" value="{{ old('picture_url') }}" required autocomplete="picture_url" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="is_disabled" type="radio" name="is_disabled" value="{{ old('is_disabled') }}" required autocomplete="is_disabled" autofocus> Yes

                                <input id="is_disabled" type="radio" name="is_disabled" value="{{ old('is_disabled') }}" required autocomplete="is_disabled" autofocus checked> No
